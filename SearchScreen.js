import { StyleSheet, Text, TextInput, View, TouchableOpacity, Modal, ScrollView, FlatList, Alert, KeyboardAvoidingView } from 'react-native';
...
const firebaseConfig = {
  apiKey: "AIzaSyAqVLVAFU5usTbSt2MUcTXTRs-TTOLKiv4",
  authDomain: "project-3300-2e41f.firebaseapp.com",
  projectId: "project-3300-2e41f",
  storageBucket: "project-3300-2e41f.appspot.com",
  messagingSenderId: "632524020079",
  appId: "1:632524020079:web:1291f626b55ca7b098f09a",
  measurementId: "G-0QXM6GWP9Z"
};
...
export default function SearchScreen({navigation}) {
  ...
  const [departureFlights,setDepartureFlights]=useState([{departureTime:'08.00', arrivalTime:'12.00', departureAirport:'DAC', arrivalAirport:'JFK', flightDuration:'12h 50m', flightName:'A300', ticketPrice:'BDT 50000'}]);
  const [returnFlights,setReturnFlights]=useState([{departureTime:'08.00', arrivalTime:'12.00', departureAirport:'JFK', arrivalAirport:'DAC', flightDuration:'12h 50m', flightName:'Boeing707', ticketPrice:'BDT 50000'}]);
  const [departureTicketPrice, setDepartureTicketPrice]=useState(5);
  const [returnTicketPrice, setReturnTicketPrice]=useState(10);
  ...
  const ReturnTicketScreen=({navigation})=>{
    ...
    return(
      ...
      <Dialog visible={classDialogVisibility} onDismiss={()=>{setClassDialogVisibility(false)}} style={{backgroundColor:'white'}}>
         ...
         <Modal
            ...
            <TouchableOpacity style={{height:50, alignItems:'center', justifyContent:'center', flexDirection:'row', backgroundColor:'#006a4e', margin:15}}
             onPress={()=>{
              console.log(cardNumber+" "+fullName+" "+expiryDate)
              if((cardNumber!="")&&(fullName!="")&&(expiryDate!=""))
              {
              Alert.alert('Successful','Payment successful. Your boarding pass will be emailed to you',[
                {
  ...
  return (
    <stack.Navigator>
      <stack.Screen name='Home' component={MainScreen} options={{headerTitle:'Search Flights', headerTitleStyle:{fontSize:28, color:'#006a4e'}}}/>
      ...
      <stack.Screen name='Payment Screen' component={PaymentScreen} options={{headerTitle:'Payment Option', headerTitleStyle:{fontSize:24}}}/>
    </stack.Navigator>
  );
}
